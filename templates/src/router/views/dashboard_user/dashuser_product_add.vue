...
export default {
  ...
  data() {
    return {
      ...
      editorData: "<h6>Add product description</h6>",
      dropzoneOptions: {
            ...
            <div class="col-6">
              <div class="topbox-items">
                <div class="items-overview-filter mr-3">
                  <!-- <router-link tag="a" to="/" class="btn btn-secondary">Discard</router-link> -->
                  <button type="reset" class="btn btn-secondary">Discard</button>
                </div>
                <div class="items-overview-filter">
                  <!-- <router-link tag="a" to="/" class="btn btn-primary btn-base">Save</router-link> -->
                  <button
                    type="submit"
              ...
              <div class="card-body">
                <div class="product-desc">
                  ...
                  <div class="form-group marginbot-20">
                    ...
                    <p class="text-primary float-right mt-3">+ Descriptions</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div class="card">
              <div class="card-body">
                <div class="product-variant">
                  ...
                  <p>This feature allow variant to a product such as size and clour</p>
                  ...
                  <div class="buttonbox toright mt-3">
                    <!-- <b-button v-b-modal.add-variant variant="primary"> -->
                      <p class="text-primary">+ Add Variant</p>
                    <!-- </b-button> -->
                  </div>
                </div>
              </div>
              ...
              <div class="card">
                <div class="card-body">
                  <div class="prodbox-shipping">
                    ...
                    <p class="mb-2 _clblack">This is a physical product</p>
                    <div class="form-group">
